...
TEST_CASE("minimap hit guard absorbs imprecise touches around the rendered frame") {
  const ChromeState state;
  CHECK(tinydraw::vector_v2::chrome_minimap_contains({250.0F, 224.0F}, state));
  CHECK(tinydraw::vector_v2::chrome_minimap_contains({266.0F, 226.0F}, state));
  CHECK(tinydraw::vector_v2::chrome_minimap_contains({367.0F, 371.0F}, state));
  CHECK_FALSE(tinydraw::vector_v2::chrome_minimap_contains({249.0F, 223.0F}, state));
  CHECK_FALSE(tinydraw::vector_v2::chrome_minimap_contains({310.0F, 223.0F}, state));
  ...
  CHECK(tinydraw::vector_v2::chrome_minimap_level_point({272.0F, 232.0F}, navigation) ==
        tinydraw::vector_v2::ChromeLevelPoint{});
  CHECK(tinydraw::vector_v2::chrome_minimap_level_point({312.0F, 281.0F}, navigation) ==
        tinydraw::vector_v2::ChromeLevelPoint{1472, 1792});
  CHECK(tinydraw::vector_v2::chrome_minimap_level_point({352.0F, 330.0F}, navigation) ==
...
TEST_CASE("minimap pointer absolutely centers the viewport at every zoom") {
  ...
  CHECK(tinydraw::vector_v2::chrome_minimap_drag_origin({352.0F, 330.0F}, {352.0F, 330.0F}, focus,
                                                        navigation) ==
  ...
  CHECK(tinydraw::vector_v2::chrome_minimap_drag_origin({352.0F, 330.0F}, {312.0F, 281.0F}, focus,
                                                        navigation) ==
        tinydraw::vector_v2::ChromeLevelPoint{2'760, 3'398});
  // Projection clamps continuously at every world edge.
  CHECK(tinydraw::vector_v2::chrome_minimap_drag_origin({352.0F, 330.0F}, {272.0F, 232.0F}, focus,
                                                        navigation) ==
        tinydraw::vector_v2::ChromeLevelPoint{});
}
