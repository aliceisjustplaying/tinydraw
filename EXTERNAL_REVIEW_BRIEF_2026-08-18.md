...
4. `review_findings_2026_08_16_cold_campaign/HANDOVER.md` sections 4 and 5 for
...
8. `VECTOR_V2_AUTHORITY_UNDO_DESIGN.md`,
   `VECTOR_V2_COMMITTED_OVERLAY_DESIGN.md`, and
   `VECTOR_V2_AUTOSAVE_DESIGN.md` for current authority transitions.
