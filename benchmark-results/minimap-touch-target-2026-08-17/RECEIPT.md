...
Glass feedback liked minimap navigation but found the tiny 400% viewport
...
- [`product-device.log`](product-device.log): the ordinary product image was
  flashed after the author's SVG test and reached `TINYDRAW_VECTOR_V2_READY`
...
The first build deliberately left the device available for the author's physical
SVG USB test. After the author reset the device and explicitly said it was ready,
...
glass check of the new 400% threshold remains.
