...
| Minimap navigation | **Green automated — owner likes it; high-zoom tuning pending glass** | The whole minimap owns gestures for every tool: stationary tap-to-jump, then continuously captured viewport drag through the existing boundary-drained pan path. Owner glass feedback on 2026-08-17 was positive but found the tiny 400% viewport hard to grab; drag promotion now scales from 4 px at ≤100% to 3 px at 200% and 2 px at 400%, retaining one pixel of jitter tolerance without stealing more canvas ([navigation receipt](benchmark-results/minimap-navigation-2026-08-17/RECEIPT.md), [touch-target receipt](benchmark-results/minimap-touch-target-2026-08-17/RECEIPT.md)). |
