...
class Co5300PanelTransport final : public DisplayBackend {
 public:
  ...
  // each source strip into internal DMA memory, applies its patch in the
  // selected byte order, and submits RAMWR/RAMWRC continuations. It never drains;
