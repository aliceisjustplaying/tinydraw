...
- **Double buffer:** copy all live pixels to the inactive overview, rasterize there, then swap active/inactive roles. This removes the second complete copy.
...
- the live overview address stays stable, preserving the current pin/source lifetime model;
