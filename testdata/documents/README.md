...
## captured-drawing-2026-08-19

A hand-drawn stress-test document, pulled from the device's `drawing`
...
- `captured-drawing-2026-08-19.journal.zst` — losslessly compressed raw partition
...
- `captured-drawing-2026-08-19.tdoc` — compact battery-corpus form (22,170
...
recorded in
[`benchmark-results/captured-drawing-battery-2026-08-19/RECEIPT.md`](../../benchmark-results/captured-drawing-battery-2026-08-19/RECEIPT.md).
